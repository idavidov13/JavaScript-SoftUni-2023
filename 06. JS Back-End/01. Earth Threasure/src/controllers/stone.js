...
stoneRouter.post(
  ...
  body("name")
    .trim()
    .isLength({ min: 2 })
    .withMessage("name must be at least 2 charachters"),
  body("category")
    .trim()
    .isLength({ min: 2 })
    .withMessage("category must be at least 2 charachters"),
  body("color")
    .trim()
    .isLength({ min: 3 })
    .withMessage("color must be at least 3 charachters"),
  body("image")
    .trim()
  ...
  body("location")
    ...
    .withMessage("location must be between 5 and 15 charachters"),
  body("formula")
    .trim()
    .isLength({ min: 3, max: 30 })
    .withMessage("formula must be between 3 and 30 charachters"),
  body("description")
    .trim()
    .isLength({ min: 10 })
    .withMessage("description must be at least 10 charachters"),
